...
original source is [here](https://github.com/clovaai/deep-text-recognition-benchmark)<br><br>
...
<img src="https://github.com/clovaai/deep-text-recognition-benchmark/blob/master/figures/trade-off.png?raw=true" width="1000" title="trade-off">
...
## Updates
**Feb 2, 2023**: rewritten with pytorch-lightning. <br>
...
## Getting Started
### Dependency
- This work was tested with PyTorch 1.13.1, CUDA 11.6, python 3.8.15 and Ubuntu 20.04. <br> You may need `pip3 install torch==1.13.1`. <br>
In the paper, expriments were performed with **PyTorch 0.4.1, CUDA 9.0**.
- requirements : pytorch-lightning, lmdb, pillow, torchvision, nltk, natsort
```shell
...
1. Download pretrained model from [here](https://drive.google.com/file/d/1-oVujDx3bREgDx5lQ9C0VXXbI330YAth/view?usp=share_link) to `saved_models/`
2. Add image files to test into `demo_images/`
3. Run demo.py (modify `sensitive` option in `config.yaml` if you use case-sensitive model)
```shell
python scripts/predict.py
```

### Training and evaluation
1. Try to train and test our best accuracy model TRBA (**T**PS-**R**esNet-**B**iLSTM-**A**ttn) also. ([download pretrained model](https://drive.google.com/file/d/1-oVujDx3bREgDx5lQ9C0VXXbI330YAth/view?usp=share_link))
...
* `benchmark_all_eval`: evaluate with 10 evaluation dataset versions, same with Table 1 in our paper. but this may not work in my version.
...
<img src="https://github.com/clovaai/deep-text-recognition-benchmark/blob/master/figures/failure-case.jpg?raw=true" width="1000" title="failure cases">
